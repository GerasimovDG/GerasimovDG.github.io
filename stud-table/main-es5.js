(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Student = /** @class */ (function () {
                function Student(id, lastName, firstName, middleName, birthday, averageMark) {
                    if (id === void 0) { id = 0; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DataHandlerService = /** @class */ (function () {
                ...
                DataHandlerService.prototype.getLastID = function () {
                ...
                DataHandlerService.prototype.deleteStudent = function (stud) {
                    _data_test_data__WEBPACK_IMPORTED_MODULE_2__["TestData"].students = _data_test_data__WEBPACK_IMPORTED_MODULE_2__["TestData"].students.filter(function (student) { return student !== stud; });
                };
                DataHandlerService.prototype.setEditStudent = function (stud) {
                    this.student = stud;
                    this.isCallDelFormService = true;
                };
                DataHandlerService.prototype.editStudent = function (stud) {
                    var find = _data_test_data__WEBPACK_IMPORTED_MODULE_2__["TestData"].students.find(function (student) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddFromComponent = /** @class */ (function () {
                function AddFromComponent(dataHandler) {
                    this.dataHandler = dataHandler;
                }
                AddFromComponent.prototype.ngOnInit = function () {
                ...
                AddFromComponent.prototype.submitStudent = function () {
                    if (this.form.valid) {
                        var data = Object.assign({}, this.form.value);
                        var newStudent = new _model_students__WEBPACK_IMPORTED_MODULE_3__["Student"](this.dataHandler.getLastID() + 1, data.fio.lastName, data.fio.firstName, data.fio.middleName, new Date(data.birthday), data.mark);
                        this.dataHandler.addStudent(newStudent);
                        this.form.reset();
                    }
                };
                return AddFromComponent;
            }());
            AddFromComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DeleteFormComponent = /** @class */ (function () {
                function DeleteFormComponent(dataHandler) {
                    this.dataHandler = dataHandler;
                }
                ...
                DeleteFormComponent.prototype.formatDate = function (date) {
                ...
                DeleteFormComponent.prototype.setEditStudent = function (student) {
                ...
                DeleteFormComponent.prototype.submitEditStudent = function () {
                    if (this.delForm.valid) {
                        var data = Object.assign({}, this.delForm.value);
                        var newStudent = new _model_students__WEBPACK_IMPORTED_MODULE_3__["Student"](this.dataHandler.student.id, data.fio.lastName, data.fio.firstName, data.fio.middleName, new Date(data.birthday), data.mark);
            ...
            DeleteFormComponent.ctorParameters = function () { return [
                { type: _service_data_handler_service__WEBPACK_IMPORTED_MODULE_4__["DataHandlerService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudentsComponent = /** @class */ (function () {
                function StudentsComponent(dataHandler) {
                    this.dataHandler = dataHandler;
                ...
                StudentsComponent.prototype.trackByStudentID = function (student) {
                    return student.id;
                };
                ...
                StudentsComponent.prototype.setStudentsByMark = function () {
                    ...
                    if (!this.mark) {
                        ...
                        this.students = this.dataHandler.getStudents().filter(function (student) {
                ...
                StudentsComponent.prototype.setStudentsByBirthday = function () {
                    if (!this.birthday) {
                        ...
                        this.students = this.dataHandler.getStudents().filter(function (student) {
                            // this.students = this.tmpStudents.filter(student => {
                            return student.birthday.getTime() === dateBirthday_1.getTime();
                        });
                    }
                };
